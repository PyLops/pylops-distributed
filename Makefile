...
install_conda:
	conda env create -f environment.yml && source activate pylops-distributed && pip install .

dev-install_conda:
	conda env create -f environment-dev.yml && source activate pylops-distributed && pip install -e .
